...
const faqData = [
  { question: "How does slice work?", answer: "Slice works by integrating seamlessly with your existing data sources, providing real-time analytics and insights without complex setup processes." },
  { question: "Is my data course?", answer: "Yes, your data is completely secure. We use end-to-end encryption and comply with all major data protection regulations to ensure your information is safe." },
  { question: "Does slice work well large team?", answer: "Absolutely. Slice is designed for scalability and collaboration, offering features that allow large teams to work together efficiently on data analysis and reporting." },
  { question: "How do create a new account?", answer: "You can create a new account by clicking the 'Try for free' button and following the simple on-screen instructions. It only takes a couple of minutes to get started." }
];
...
const AccordionItem = ({ faq, onToggle, isActive }) => (
  <div className="py-6 border-b border-gray-700">
    ...
    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isActive ? 'max-h-40 mt-4' : 'max-h-0'}`}>
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <header className="text-center max-w-4xl mx-auto">
          <nav className="text-sm mb-4">
            <a href="#" className="text-[#A9A9A9] hover:text-white">Home</a>
        ...
        {/* FAQ Section */}
        <section className="ml-20 w-[90%] grid grid-cols-1 md:grid-cols-2 gap-16 items-start mt-24">
